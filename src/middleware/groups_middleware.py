...
from src.models import Groups, NoResultFound, session
...
class GroupsReader:
    ...
    def __init__(self, *, _id:int):
        self._id = _id
        try:
            self.group = session.query(Groups).filter(Groups.id == self._id).one_or_none()
...
class GroupsList:
    ...
    def __init__(self,*,
        ...
        self.count = session.query(Groups).count()
